// Auto-generated by scripts/build-figma-plugin.mjs — do not edit directly
var PAYLOAD = {
  "project": "StudioFlow",
  ...
  "sections": [
    ...
    },
    {
      "type": "hero",
      "sfids": {
        "root": "sfid:hero-content",
        "kicker": "sfid:hero-kicker",
        "title": "sfid:hero-title",
        "body": "sfid:hero-body",
        "actions": "sfid:hero-actions",
        "primaryCta": "sfid:hero-primary-cta",
        "secondaryCta": "sfid:hero-secondary-cta"
      },
      "content": {
    ...
    },
    {
      ...
      "content": {
        ...
        "items": [
          {
            "heading": "Token styles",
            "lines": [
              {
                "text": "Named styles stay token-based across the full loop.",
                "style": "signal"
              },
              {
                "text": "npm run verify:tokens-sync",
                "style": "signal"
              },
              {
                "text": "tokens/figma-variables.json + generated token files",
                "style": "muted"
              }
            ]
          },
          {
            ...
            "lines": [
              {
                "text": "Mobile, tablet, laptop, and desktop layouts are all checked.",
                "style": "signal"
              },
              {
                "text": "npm run loop:verify-canvas",
                "style": "signal"
              },
              {
                "text": "handoff/canvas-to-code.json -> variableModes + screens",
                "style": "muted"
              }
            ]
          },
          {
            "heading": "Component anchors",
            "lines": [
              {
                "text": "Stable sfid anchors keep each screen part matched.",
                "style": "signal"
              },
              {
                "text": "npm run verify:id-sync",
                "style": "signal"
              },
              {
                "text": "source data-sfid attributes + snapshots/*.json",
                "style": "muted"
              }
            ]
          },
          {
            ...
            "lines": [
              {
                "text": "Code updates only run after payload checks pass.",
                "style": "signal"
              },
              {
                "text": "npm run loop:verify-canvas",
              ...
              {
                "text": "verification gate before loop:canvas-to-code",
                "style": "muted"
              }
            ]
          }
    ...
    },
    {
      ...
      "content": {
        ...
        "items": [
          {
            "heading": "1) Send code to Figma",
            "lines": [
              {
                "text": "Generate handoff/code-to-canvas.json from the current app state.",
                "style": "muted"
              },
              {
                "text": "Figma gets the same token and anchor map used in code.",
                "style": "muted"
              },
              {
          ...
          {
            "heading": "2) Edit in Figma",
            "lines": [
              {
                "text": "Use Conduit in Figma and export handoff/canvas-to-code.json.",
                "style": "muted"
              },
              {
                "text": "Your approved edits are packaged for a safe apply step.",
                "style": "muted"
              },
              {
                "text": "npm run loop:verify-canvas",
          ...
          {
            "heading": "3) Apply back to code",
            "lines": [
              {
                "text": "Run the apply wrapper to verify, apply, check, build, and create proof output.",
                "style": "muted"
              },
              {
                "text": "Code and Figma remain aligned with a review trail.",
                "style": "muted"
              },
              {
      ...
      "content": {
        "panels": [
            ...
            "items": [
              {
                ...
                "lines": [
                  {
                    "text": "Install the project and finish MCP + Conduit setup.",
                    "style": "muted"
                  },
                  {
                    "text": "npm run setup:project",
                    "style": "signal"
                  },
                  {
                    "text": "Use docs/MCP_SETUP.md and docs/CONDUIT_SETUP.md.",
                    "style": "muted"
                  }
                ]
              },
              {
                "heading": "Prepare payload",
                "lines": [
                  {
                    "text": "Build tokens and generate the code-to-Figma payload.",
                    "style": "muted"
                  },
                  {
                  ...
                  {
                    "text": "Output file: handoff/code-to-canvas.json",
                    "style": "muted"
                  }
                ]
              },
              ...
              {
                "heading": "Apply safely",
                "lines": [
                  {
                    "text": "After Figma export, run one command to apply and generate proof output.",
                    "style": "muted"
                  },
                  {
                    "text": "npm run loop:figma-roundtrip:apply",
                  ...
                  {
                    "text": "Output files: proof/latest/index.html + studioflow.manifest.json",
                    "style": "muted"
                  }
                ]
              }
          ...
          },
          {
            ...
            "items": [
              {
                "heading": "Anchor continuity",
                "lines": [
                  {
                    "text": "Every required sfid appears in source, payloads, and snapshots.",
                    "style": "muted"
                  },
                  {
                    "text": "npm run verify:id-sync",
              ...
              {
                "heading": "Token authority",
                "lines": [
                  {
                    "text": "tokens/figma-variables.json remains the source for token names and values.",
                    "style": "muted"
                  },
                  {
                    "text": "npm run verify:tokens-sync",
              ...
              {
                "heading": "Mode coverage",
                "lines": [
                  {
                    "text": "All four breakpoint modes are required in the payload.",
                    "style": "muted"
                  },
                  {
                    "text": "npm run loop:verify-canvas",
              ...
              },
              {
                ...
                "lines": [
                  {
                    "text": "Code updates stop automatically if verification fails.",
                    "style": "muted"
                  },
                  {
                    "text": "npm run loop:figma-roundtrip:apply",
        ...
        "items": [
          {
            ...
            "lines": [
              ...
              {
                "text": "The wrapper command prints exactly what to do next.",
                "style": "muted"
              }
            ]
          },
          {
            "heading": "Consistent breakpoints",
            "lines": [
              {
                "text": "All 4 required",
                "style": "text"
              ...
              {
                "text": "Verification blocks partial payloads before apply.",
                "style": "muted"
              }
            ]
          },
          {
            ...
            "lines": [
              {
                "text": "No random style values",
                "style": "text"
              },
              {
                "text": "Token and hardcoded-style checks run before release.",
                "style": "muted"
              }
            ]
          },
          {
            "heading": "Review-ready proof",
            "lines": [
              {
                "text": "Every apply",
                "style": "text"
              ...
              {
                "text": "Proof pages and manifest updates capture each loop.",
                "style": "muted"
              }
            ]
          },
          {
            ...
            "lines": [
              ...
              {
                "text": "Use the StudioFlow Figma plugin when Conduit is unavailable.",
                "style": "muted"
              }
            ]
          }
        ...
        "items": [
          {
            ...
            "lines": [
              {
                "text": "Connect Figma Dev Mode MCP (read) and Conduit (write) in your MCP client.",
                "style": "muted"
              },
              {
                "text": "Open MCP_SETUP.md",
                "style": "muted"
              }
            ]
          },
          {
            "heading": "Conduit setup",
            "lines": [
              {
                "text": "Install and pair the Conduit MCP server and Figma plugin.",
                "style": "muted"
              },
              {
                "text": "Open CONDUIT_SETUP.md",
                "style": "muted"
              }
            ]
          },
          {
            "heading": "Roundtrip walkthrough",
            "lines": [
              {
                "text": "Follow the full demo flow from code to Figma and back.",
                "style": "muted"
              },
              {
          ...
          },
          {
            ...
            "lines": [
              {
                "text": "See the full system model and required quality gates.",
                "style": "muted"
              },
              {
